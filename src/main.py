    ...
    def __init__(self):
        ...
        self.content = Column(
            controls = [
                        ...
                        self.result_text_2, 
                        Row([self.ab_ob_icon, 
                             Text("Абдоминальное ожирение", size=16, expand=True)]),
                        Row([self.high_bl_pr_icon,
                            Text("Повышенное артериальное давление", size=16, expand=True)]),
                        Row([self.hyp_icon,
                             Text("Наличие артериальной гипертензии", size=16, expand=True)]),
                        Row([self.anti_h_th_icon,
                             Text("Прием антигипертензивных препаратов", size=16, expand=True)]),
                        Row([self.hs_lpvp_icon,
                             Text("Снижение ХС-ЛПВП", size=16, expand=True)]),
                        Row([self.hyp_lip_th_icon,
                             Text("Прием гиполипидемических препаратов (статины, фибраты, др.)", size=16, expand=True)]),
                        Row([self.hypertriglyceridemia_icon,
                             Text("Гипертриглицеридемия", size=16, expand=True)]),
                        ...
                        Row([self.diabetes_sec_type_icon,
                             Text("Сахарный диабет 2-го типа", size=16, expand=True)]),
                        Row([self.cad_icon,
                             Text("ИБС. Стабильная стенокардия", size=16, expand=True)]),
                        Row([self.cad_mi_icon,
                             Text("ИБС. Перенесенный острый коронарный синдром", size=16, expand=True)]),
                        Row([self.chf_icon,
                             Text("ХСН", size=16)]),
                        Row([self.stent_bypass_icon,
                             Text("Стентирование и/или шунтирование в анамнезе", size=16, expand=True)]),
                        ...
                        Row([self.periph_art_dis_icon,
                             Text("Заболевания периферических артерий", size=16, expand=True)]),
